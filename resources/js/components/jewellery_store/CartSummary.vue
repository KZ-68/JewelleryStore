...
<template>
    <section id="cart-summary" class="h-full w-1/4 my-10 px-8 pt-20 pb-10 bg-white rounded-lg dark:bg-gray-900">
        <h1 class="font-semibold text-2xl border-b pb-8 dark:text-gray-100 dark:border-gray-700">{{ useTrans('Cart Summary') }}</h1>
        ...
        <div id="total-cost-wrapper" class="border-t mt-8 dark:border-gray-700 dark:text-gray-200">
