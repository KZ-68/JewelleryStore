    ...
    <section id="contact-form-wrapper" class="my-10 mx-15 max-w-[900px] flex-start py-6 px-8 gap-1 rounded-lg bg-white p-1 dark:bg-neutral-800">
        ...
        >
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    <Label for="ean13">EAN13 Bar Code</Label>
                    <Input
                        id="ean13"
                        type="text"
                        name="ean13"
                ...
                <section id="admin-product-details-footer" class="flex flex-row gap-4 py-8 px-10">
                    <Link :href="showProducts()" class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]">
