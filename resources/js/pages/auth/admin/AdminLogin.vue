...
<template>
    ...
    <main class="flex flex-row bg-gray-100 rounded-xl border-t-[1px] border-gray-100 min-h-svh dark:bg-gray-950 dark:border-gray-900">
        <aside id="admin-login-form-background" class="lg:ml-10 lg:my-10 lg:w-50/50">
            <figure id="admin-login-form-figure" class="h-full">
        ...
        <section id="admin-login-section" class="lg:mr-10 lg:my-10 lg:px-10 lg:py-10 rounded-r-xl lg:w-50/50 bg-white dark:bg-gray-900">
            <h1 class="text-3xl mb-6 dark:text-gray-100">Log in to your admin account</h1>
