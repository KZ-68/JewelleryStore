...
<template>
    ...
    <AppLayout>
      <AdminProductMainForm classname="" :product=props.product :taxRuleGroups=props.taxRuleGroups :priceWithTax=props.priceWithTax :taxRuleGroupId=props.taxRuleGroupId></AdminProductMainForm>
