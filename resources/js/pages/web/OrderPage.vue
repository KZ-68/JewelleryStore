...
<template>
  ...
  <div v-if="flashError" role="alert" class="mx-auto max-w-screen-xl w-full px-6 lg:px-12 pt-6">
    <div class="flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 dark:bg-red-950/30 dark:border-red-900/40 dark:text-red-400">
  ...
  <main id="order-page-wrapper" class="flex flex-col lg:flex-row lg:items-start py-6 md:px-6 lg:px-12 gap-6 justify-evenly bg-gray-100 min-h-screen dark:bg-gray-950">
