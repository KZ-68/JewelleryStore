...
<template>
    <section id="discover-category-section" class="flex flex-col items-center my-24 h-96 max-h-96 lg:h-[32rem] lg:max-h-[32rem] w-full">
        ...
        <div id="discover-category-wrapper" class="flex flex-row w-72 lg:w-[96rem] my-12 border-2 border-[#84070F] rounded-md">
            ...
            <div id="discover-category-right" class="flex flex-col gap-16 justify-center items-start px-12">
                ...
                <button id="discover-btn" class="bg-[#84070F] py-2 px-3">
                    <Link :href="route('showCategoryProducts', {category_slug: 'collections'}, false, Ziggy)">
