    ...
    <AppLayout>
      <div id="features-page-wrapper"  class="items-center min-h-screen p-10 text-[#1b1b18] lg:justify-center lg:p-14 bg-neutral-200 dark:bg-[#0a0a0a]">
        ...
        <section id="features-top-wrapper" class="flex lg:flex-row sm:flex-col lg:my-0 sm:my-6 justify-between items-center">
            <div id="features-filters-wrapper" class="flex flex-row my-6 gap-4">
              <label for="sortBy" class="my-4">Order by :</label>
              <select id="sortBy" v-model="sortBy" @change="updateFeaturesFilters" class="rounded-md bg-neutral-100 px-2">
                <option value="id">Id</option>
                <option value="name">Name</option>
                <option value="created_at">Date created</option>
              </select>
              <select id="order" v-model="order" @change="updateFeaturesFilters" class="rounded-md bg-neutral-100 px-2">
