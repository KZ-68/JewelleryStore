...
<template>
    <section id="features-list-wrapper" class="bg-gray-100 rounded-lg py-4 px-2 sm:px-6 md:px-12">
        <div class="overflow-x-auto">
            <table class="flex flex-col gap-4 min-w-[360px] w-full">
                ...
                <tbody v-if="features.length > 0" id="features-list">
                    <tr v-for="feature in features" v-bind:key="feature.id" class="flex flex-row gap-[5%] items-center justify-around bg-gray-200 py-3 px-3 my-4 rounded-md min-h-[4rem] h-auto">
