...
<template>
    <section id="products-list-wrapper" class="bg-gray-100 rounded-lg py-4 px-2 sm:px-6 md:px-12">
        <div class="overflow-x-auto">
            <table class="flex flex-col gap-4 min-w-[520px] w-full">
                ...
                <tbody v-if="products.length > 0" id="products-list">
                    <tr v-for="product in products" v-bind:key="product.id" class="flex flex-row gap-[5%] items-center justify-around bg-gray-200 py-3 px-3 my-4 rounded-md min-h-[4rem] h-auto">
