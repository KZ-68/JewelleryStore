...
<template>
    <nav aria-label="Catégories" class="bg-white w-full px-4 md:px-6 max-w-screen-2xl mx-auto dark:bg-gray-900">
        <ul class="flex flex-col lg:flex-row lg:items-center">
            ...
            >
                <div
                    ...
                    class="flex items-center px-4 py-3 hover:bg-gray-50 transition-colors dark:hover:bg-gray-800"
                >
                    <a
                        :href="route('showCategoryProducts', {locale: props.locale, category_slug: category.slug}, false, Ziggy)"
                        class="flex-1 font-medium text-sm text-gray-800 hover:text-[#84070F] transition-colors focus:outline-none focus:ring-2 focus:ring-[#84070F] rounded-sm dark:text-gray-200"
                    >
                        {{ category.name }}
                    </a>
                    ...
                    <button
                        ...
                        class="ml-2 p-1 rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#84070F] transition-colors cursor-pointer dark:hover:bg-gray-700"
                    >
                        <svg
                            aria-hidden="true"
                ...
                <ul
                    ...
                    role="list"
                    class="absolute left-0 top-full z-20 flex flex-col bg-white border border-gray-100 shadow-lg rounded-md overflow-hidden min-w-[200px] dark:bg-gray-900 dark:border-gray-700"
                >
                    <SubCategory
